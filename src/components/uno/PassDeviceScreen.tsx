  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="rounded-xl bg-linear-to-r from-red-500 to-orange-500 px-8 py-3 text-lg font-bold text-white shadow-lg ring-1 ring-white/20">
          {t('tapWhenReady')}
        </span>
      </button>
    </m.div>
